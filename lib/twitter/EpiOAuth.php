...
class EpiOAuthException extends Exception
{
  public static function raise($response, $debug)
  {
	...
	//$CONSUMER_KEY		= "Pmn0lHsGwb9enW72aJRhQ";						//dev apps
	//$CONSUMER_SECRET	= "V0p9yQEJuNUr7c8hNia62WhvZ7Wm6wMMPA7tGGlQ";	//dev apps
    $message = $response->responseText;
	/*echo "<script>top.location.href='index.php'</script>";*/
	
	//$twitter = new EpiTwitter($CONSUMER_KEY, $CONSUMER_SECRET);
	//$twitter = new EpiOAuth($CONSUMER_KEY, $CONSUMER_SECRET);
	/*echo "<script>top.location.href='".$twitter->getAuthorizeUrl()."'</script>";*/
